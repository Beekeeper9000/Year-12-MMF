...
The program will record the tickets sale and calculate the 
...
while tickets_sold < MAX_TICKETS:
    # ask user for their name (and check their )
    print()
    name = not_blank("Name: ")
    ...
    # add name, ticket cost and surcharge to total cost
...
if tickets_sold == MAX_TICKETS:
    print(f"You have sold all the tickers")
else:
